...
def is_valid_channel(message, lower_message, is_helper, is_push_bot):
    ...
    if message.channel.id == constants.BOT_CHANNEL:
        ...
        if lower_message.find('card') != -1 or lower_message.find('pack') != -1 or lower_message.find('token') != -1 or lower_message.find('donate') != -1 or lower_message.find('gallery') != -1  or lower_message.find('unopened') != -1:
            return True, None
