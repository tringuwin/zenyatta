...
async def update_shop(db, message):
    ...
    offers_string = '***The Token Shop can only be used by Twitch Subscribers. The Token Shop is Re-Stocked at around noon ET each Friday.*** (To Access, subscribe here: https://www.twitch.tv/solnetwork )\n'
