...
async def update_shop(db, message):
    ...
    offers_string += '*Prices for these items change on a weekly basis. If an item fully sell out, the price is raised 100 tokens, otherwise, the price is lowered 100 tokens.*\n\n'
    offers_string += '-------------------------------\n**AVAILABLE REWARDS**\n-------------------------------\n'
