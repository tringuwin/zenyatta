...
def time_to_shop(diff_in_time):
    ...
    time_to_gift = constants.TIME_BETWEEN_SHOP - diff_in_time
    ...
    return format_time(days, 'days')+format_time(hours, 'hours')+format_time(minutes, 'minutes')+format_time(time_to_gift, 'seconds')
